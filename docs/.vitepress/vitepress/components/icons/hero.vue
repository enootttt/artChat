<template>
  ...
  >
    <g clip-path="url(#__lottie_element_14)">
      ...
      >
        <g
          transform="matrix(0.9333299994468689,0,0,0.9333299994468689,741.6007080078125,442.7997131347656)"
          opacity="0.5"
          style="display: none"
        >
        ...
        <g
          transform="matrix(0.8399999737739563,0,0,0.8399999737739563,772.43505859375,240.6540069580078)"
          opacity="0.5"
          style="display: none"
        >
          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
        ...
        <g
          transform="matrix(0,0.7559999823570251,-0.7559999823570251,0,936.1370239257812,95.88749694824219)"
          opacity="0.5"
          style="display: none"
        >
          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
        ...
        <g
          transform="matrix(0,0.680400013923645,-0.680400013923645,0,1180.6092529296875,120.86973571777344)"
          opacity="0.5"
          style="display: none"
        >
          <g opacity="1" transform="matrix(1,0,0,1,0,0)">
        ...
        <g
          class="png"
          style="display: block"
          transform="matrix(0.5,0,0,0.5,816,154.97036743164062)"
          opacity="1"
        >
          <image
            width="896px"
        ...
        <g
          class="png"
          transform="matrix(0.5,0,0,0.5,948,247.97036743164062)"
          opacity="1"
          style="display: block"
        >
          <image
        ...
        <g
          class="png"
          style="display: block"
          transform="matrix(0.5,0,0,0.5,1122,175.97036743164062)"
          opacity="1"
        >
          <image
            width="240px"
        ...
        <g
          class="png"
          style="display: block"
          transform="matrix(0.5,0,0,0.5,976,148.9708709716797)"
          opacity="1"
        >
          <image
            width="266px"
