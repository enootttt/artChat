...
type UseCollapsible = (collapsible?: Collapsible) => [boolean, Ref<RequiredCollapsibleOptions["expandedKeys"]>, ((curKey: string) => void) | undefined];

const useCollapsible: UseCollapsible = (collapsible) => {
  let baseConfig = ref<RequiredCollapsibleOptions>({
    expandedKeys: [],
    onExpand: () => {},
  });
  // ============================ Collapsible ============================
  ...
  // ============================ Return ============================
  return [collapsibleOptions.value[0], mergedExpandedKeys, collapsibleOptions.value[0] ? onItemExpand : undefined];
};
